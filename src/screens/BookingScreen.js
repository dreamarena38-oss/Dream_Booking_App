...
export default function BookingScreen({ navigation }) {
  ...
  const renderGroundItem = (ground, index) => {
    return (
      ...
      >
        <Image 
          source={{ uri: ground.image || 'https://images.pexels.com/photos/274506/pexels-photo-274506.jpeg' }} 
          ...
          <View style={styles.groundFooter}>
            <View style={styles.ratingContainer}>
              ...
              <Text style={styles.ratingText}>
                {ground.averageRating?.toFixed(1) || '0.0'} ({ground.reviewCount || 0} reviews)
              </Text>
            </View>
    ...
    <View style={styles.container}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Find the perfect ground for your game</Text>
        </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptySubtext}>Check back later for new grounds</Text>
            </View>
          }
          refreshControl={
